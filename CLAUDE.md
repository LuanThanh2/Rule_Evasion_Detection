...
| **B — Stage 2 Attribution** | ✅ process_creation; ⚠️ ps/reg partial | Cosine top-1=68.8% vs SVM 23.5%; 1,579 rules trong catalog |
...
### Stage 2 Attribution results (process_creation, 83 rules, 298 evasion samples)
...
2. **Cosine attribution accuracy** — Top-1 68.8% vs SVM 23.5%
